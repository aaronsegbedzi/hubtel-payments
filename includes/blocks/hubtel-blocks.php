...
final class Hubtel_Blocks extends AbstractPaymentMethodType {
	...
	public function initialize() {
		$this->settings = get_option( 'woocommerce_payments-hubtel_settings', [] );
	...
	public function get_payment_method_script_handles() {
		...
		if ( function_exists( 'wp_set_script_translations' ) ) {
			wp_set_script_translations( 'wc-payments-hubtel-blocks', 'payments-hubtel' );
		}

		return [ 'wc-payments-hubtel-blocks' ];
	}
